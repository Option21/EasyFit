...
public class ProgramListProg extends Activity{
    ...
    private static String Exo1_Abdo(int position)
    {
        ...
        builder.append("Le crunch au sol\n\n");
    ...
    {
        StringBuilder builder = new StringBuilder();
        builder.append("Tractions à la barre fixe\n\n");
    ...
    {
        StringBuilder builder = new StringBuilder();
        builder.append("Les Pompes au sol\n\n");
